  ...
  implements ComponentListener
{
    ...
    private void initComponents()
    {
        ...
        articleImage = new javax.swing.JLabel();
        articleText = new javax.swing.JLabel();

        setBackground(new java.awt.Color(81, 81, 81));
        setLayout(new java.awt.GridBagLayout());

        articleImage.setBackground(new java.awt.Color(118, 118, 133));
        articleImage.setForeground(new java.awt.Color(254, 254, 254));
        articleImage.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        articleImage.setText("test");
        articleImage.setName("articleImage"); // NOI18N
        articleImage.setOpaque(true);
        ...
        articleText.setForeground(new java.awt.Color(254, 254, 254));
    ...
    private javax.swing.JLabel articleImage;
